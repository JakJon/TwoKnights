...
public class Spawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpawnSlime(2, new Vector2(-1, -6), slime, 5f, _rightPlayer);
        ...
        SpawnSlime(2, new Vector2(7, -6), slime, 50f, _leftPlayer);
        SpawnSlime(2, new Vector2(7, 6), slime, 50f, _leftPlayer);
        SpawnSlime(1, new Vector2(-1, -6), slime, 50f, _rightPlayer);
        ...
        SpawnSlime(3, new Vector2(-3, -6), slime, 65f, _rightPlayer);
        ...
        SpawnSlime(3, new Vector2(-6, -6), slime, 105f, _rightPlayer);
        SpawnSlime(3, new Vector2(0, -6), slime, 105f, _leftPlayer);
        SpawnSlime(3, new Vector2(3, 6), slime, 105f, _leftPlayer);
